...
final class IntQuadMatchWeight<A, B, C, D> extends AbstractQuadMatchWeight<A, B, C, D> {

    private final ToIntQuadFunction<A, B, C, D> weigher;

    public IntQuadMatchWeight(ToIntQuadFunction<A, B, C, D> weigher) {
    ...
    protected UndoScoreImpacter naked(WeightedScoreImpacter<?, ?> impacter, A a, B b, C c, D d) {
        var matchWeight = weigher.applyAsInt(a, b, c, d);
