...
@NullMarked
public final class DefaultNeighborhoodsBasedMoveRepository<Solution_> implements NeighborhoodsBasedMoveRepository<Solution_> {
    ...
    public DefaultNeighborhoodsBasedMoveRepository(DefaultMoveStreamFactory<Solution_> moveStreamFactory,
